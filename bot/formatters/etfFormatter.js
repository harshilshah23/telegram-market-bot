...
export function formatEtfBrief(data) {
  ...
  const emoji = getAssetEmoji(assetInfo.type, symbol);
  ...
  // What matters
  const editorial = whatMatters?.text || 'Index performance tracks macroeconomic conditions and sector allocations.';
